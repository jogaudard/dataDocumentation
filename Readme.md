...
**Manual editing**: Once you have the description table (either empty or
pre-filled), you can edit it manually in a spreadsheet program or text
editor. This is the recommended workflow for most users.

### AI-powered description generation (optional)

**OPTIONAL:** If you want to speed up the process, you can use AI to
automatically generate initial descriptions for your variables using
Google’s Gemini API. You should always review and edit the AI-generated
content.
...
Now you can use `populate_description_table()` to automatically fill in
descriptions:
...
You can provide additional context to help the AI generate better
descriptions. Context can be a character string or read from a text
file:
...
- **Description**: A concise description (1-3 sentences) that identifies
  relationships between variables and defines abbreviations
- **Units**: The unit of measurement in SI standard abbreviations (g,
  cm, m^2, etc.)
- **How measured**: Whether the variable was defined, recorded, or
  measured

**Important notes:**

- **Always review and edit** the AI-generated descriptions - they may
  not be perfect
- The function only fills in variables that have NA values, so you can
